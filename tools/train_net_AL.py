...
register_coco_instances("plates_1500_low_train", {}, "/fs/pool/pool-lambacher/Cluster_Projects/data/plates_1500_low/annotations/instances_train2017.json", "/fs/pool/pool-lambacher/Cluster_Projects/data/plates_1500_low/train2017") 
register_coco_instances("plates_1500_low_val", {}, "annotations/instances_val2017.json", "/fs/pool/pool-lambacher/Cluster_Projects/plates_1500_low") 
...
def do_train(args, cfg):
    ...
    cfg.dataloader.train.dataset.names = ("plates_1500_low_train")
    cfg.dataloader.test.dataset.names = ("plates_1500_low_val")
